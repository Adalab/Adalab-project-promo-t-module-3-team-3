    ...
    <section className='preview'>
      ...
      <section className='autor'>
        <section className='info-project'>
          ...
          <p className='slogan'>{data.slogan || 'Diseño de rutas de navegación'}</p>
          <p className='desc'>
            {data.desc ||
          ...
          <section className='technologies'>
            <p className='textTec'>{data.technologies || 'React JS, MongoDB'}</p>
            <div className='icons'>
        ...
        <section className='info-autor'>
          ...
          <p className='job'>{data.job || 'Ingeniera de sistemas informáticos'}</p>
